...
namespace Project.Context
{
    public partial class ProjectContext : DbContext
    {
        ...
        public virtual DbSet<CitizenxVaccination> CitizenxVaccinations { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CitizenxVaccination>(entity =>
            {
                entity.ToTable("CitizenxVaccination");
                ...
                entity.HasOne(d => d.Citizen)
                    .WithMany(p => p.CitizenxVaccinations)
                    .HasForeignKey(d => d.CitizenId)
                    .HasConstraintName("FK__CitizenxV__citiz__571DF1D5");

                entity.HasOne(d => d.Vaccination)
                    .WithMany(p => p.CitizenxVaccinations)
                    .HasForeignKey(d => d.VaccinationId)
                    .HasConstraintName("FK__CitizenxV__vacci__5812160E");
            });
            ...
            modelBuilder.Entity<SideEffect>(entity =>
            {
                ...
                entity.HasOne(d => d.Vaccination)
                    ...
                    .HasForeignKey(d => d.VaccinationId)
                    .HasConstraintName("FK__Side_Effe__vacci__5441852A");
            });
